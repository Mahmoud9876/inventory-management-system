                    ...
                    <div class="card-actions btn-actions">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" style="">
                                <a href="{{ route('contracts.edit', $contract->id) }}" class="dropdown-item text-warning">
                        ...
                        <x-action.close route="{{ route('contracts.index') }}" />
                    </div>
                </div>
                <div class="card-body">
                    <div class="row row-cards mb-3">
                        ...
                        <div class="col">
                            ...
                            <input type="text" id="create_by"
                                   class="form-control"
                                   value="{{ $contract->createdBy->name ?? null }}"
                                   disabled
                            >
                        </div>
                    </div>
