<div class="card">
                ...
                @forelse ($products as $product)
                    <tr>
                        ...
                        <td class="align-middle text-center" style="width: 10%">
                            <x-button.show class="btn-icon" route="{{ route('inventory.show', $inventory->uuid) }}" />
                            <x-button.edit class="btn-icon" route="{{ route('inventory.edit', $inventory->uuid) }}" />
                            <x-button.delete class="btn-icon" route="{{ route('inventory.destroy', $inventory->uuid) }}"
    ...
    <div class="card-footer d-flex align-items-center">
        <p class="m-0 text-secondary">
            Showing <span>{{ $inventory->firstItem() }}</span>
            to <span>{{ $inventory->lastItem() }}</span> of <span>{{ $products->total() }}</span> entries
        </p>
